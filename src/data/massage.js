...
export const MASSAGE_PARTS_SHIATZU = MASSAGE_PARTS.filter((parts) => parts.name !== 'Руки');

export const MASSAGE_PARTS_AIR = MASSAGE_PARTS.filter((parts) => parts.name !== 'Стопы');
